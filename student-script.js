...
document.getElementById('requestForm').addEventListener('submit', function(e) {
    ...
    DocTracker.showNotification('success', 'Document request submitted successfully!');
    
    // Simulate notification to admin
    setTimeout(() => {
        DocTracker.showNotification('info', 'Your request has been received and will be processed shortly.');
    }, 2000);
});
